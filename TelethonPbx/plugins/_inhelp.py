    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "Pbxbot_help":
            ...
            if a:
                ...
                help_pic = "https://telegra.ph/file/dc60f40937a3ff7a80b98.jpg"
            ...
            if a:
                ...
                PIC = "https://telegra.ph/file/5bd2b4dd3e18f4553da18.jpg"
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [
                        Button.url("• Repo •", "https://github.com/The-PbxBot/PbxBot"),
