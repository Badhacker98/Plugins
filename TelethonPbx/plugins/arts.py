...
@Pbx_cmd(pattern="shitos$")
async def _(shitos):
    await eor(shitos, S)


@Pbx_cmd(pattern="dislike$")
async def _(dislike):
    await eor(dislike, T)

@Pbx_cmd(pattern="baad$")
async def _(bad):
    await eor(bad, X)
