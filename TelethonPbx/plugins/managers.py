...
async def _(event):
    ...
    OUTPUT = f"**Files in 🕊️⃝‌ᴘʙx ❤️ᥫ᭡፝֟፝֟† DOWNLOADS Folder:**\n"
...
CmdHelp("managers").add_command(
    "ls_local", None, "Gives the list of downloaded medias in your Pbxbot server."
).add_command(
    "ls_root", None, "Gives the list of all files in root directory of Pbxbot repo."
).add_command(
    "ls_saved", None, "Gives the list of all files in Saved directory of your Pbxbot server"
).add_command(
