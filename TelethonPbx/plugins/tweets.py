...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Trump is making a tweet ...")
...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Modi is making a tweet ...")
...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Mia is making a tweet ...")
...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Dani is making a tweet ...")
...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Pappu is making a tweet ...")
...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Sunny is making a tweet ...")
...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Johhny is making a tweet ...")
...
async def nekobot(event):
    ...
    if reply and reply.message:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, "Gandhi is making a tweet ...")
...
async def nekobot(event):
    ...
    if len(lists) == 2:
        ...
        return await parse_error(event, "No texts were given to tweet.")
    Pbx = await eor(event, f"{username} is making a tweet ...")
...
async def nekobot(event):
    ...
    Pbx = await eor(event, "Change my mind ...")
...
async def nekobot(event):
    ...
    Pbx = await eor(event, "Kanna is writting ...")
