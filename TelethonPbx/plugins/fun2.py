...
async def hmm(Pbx):
    ...
    await eor(Pbx, reactcat)


@Pbx_cmd(pattern="why$")
async def hmm(Pbx):
    whyPbx = nekos.why()
    await eor(Pbx, whyPbx)


@Pbx_cmd(pattern="fact$")
async def hmm(Pbx):
    factPbx = nekos.fact()
    await eor(Pbx, factPbx)
