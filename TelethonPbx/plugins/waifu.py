...
async def _(event):
    ...
    if owo in neko_category:
        Pbx = await eor(event, f"`Searching {owo} ...`")
        link = nekos.img(owo)
        ...
        Pbx = await eor(event, "`Searching randoms...`")
