...
@Pbx_cmd(pattern="indflag$")
async def _(event):
    animation_interval = 0.1
    animation_ttl = range(0, 36)
    await eor(event, "Pbxo")
    animation_chars = [
        "Indian Flag",
...
async def _(event):
    ...
    animation_chars = [
        ...
        f"`Me: Hello this is` `{Pbx_mention}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: Hello Sir, How are you!!`",
        "`Prime Minister: May I Know Who Is This?`",
        f"`Me: Yes sur, itz me` `{Pbx_mention}`",
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1432756163:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master nigger!**\n\n__Your account is on hold! Pay 99$ to my master__ [🕊️⃝‌ʙᴀᴅ ❤️ᥫ᭡፝֟፝֟](https://t.me/ll_BAD_MUNDA_ll) __to release your account__😏"
            )
        else:
